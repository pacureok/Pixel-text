...
## 🏗️ Créditos y Base
Este proyecto fue creado por **Pacure Labs**. 
Utiliza como motor base la arquitectura de **Ollama** para la gestión eficiente del "cerebro" (Llama 3).

## ⚖️ Licencia
Este proyecto está bajo la licencia **Apache 2.0**.
- Se deben dar créditos a **Pacure Labs**.
- El autor no se hace responsable por fallos en versiones modificadas por terceros.
- Las modificaciones deben ser notificadas como "obras derivadas".
